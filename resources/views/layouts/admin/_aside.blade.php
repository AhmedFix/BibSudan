...
<aside class="app-sidebar">
    ...
    <ul class="app-menu">
        ...
        @if (auth()->user()->hasPermission('read_books'))
            <li><a class="app-menu__item {{ request()->is('*books*') ? 'active' : '' }}" href="{{ route('admin.books.index') }}"><i class="app-menu__icon fa fa-book"></i> <span class="app-menu__label">@lang('books.books')</span></a></li>
        @endif

        {{--authors--}}
        @if (auth()->user()->hasPermission('read_authors'))
            <li><a class="app-menu__item {{ request()->is('*authors*') ? 'active' : '' }}" href="{{ route('admin.authors.index') }}"><i class="app-menu__icon fa fa-address-book-o"></i> <span class="app-menu__label">@lang('authors.authors')</span></a></li>
        @endif
